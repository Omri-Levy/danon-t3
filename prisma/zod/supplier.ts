...
export interface CompleteSupplier extends z.infer<typeof SupplierModel> {
 ...
 */
export const RelatedSupplierModel: z.ZodSchema<CompleteSupplier> = z.lazy(() => SupplierModel.extend({
