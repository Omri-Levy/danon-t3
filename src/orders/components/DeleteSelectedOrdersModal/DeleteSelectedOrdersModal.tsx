...
import { useDeleteSelectedOrdersModal } from './hooks/useDeleteSelectedOrdersModal/useDeleteSelectedOrdersModal';

export const DeleteSelectedOrdersModal: FunctionComponent = () => {
	const {
		isOpen,
		onToggleIsDeletingSelectedOrders,
		isLoading,
		onDeleteSelectedOrders,
	} = useDeleteSelectedOrdersModal();
