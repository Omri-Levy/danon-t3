...
import { useDeleteSelectedSuppliersModal } from './hooks/useDeleteSelectedSuppliersModal/useDeleteSelectedSuppliersModal';

export const DeleteSelectedSuppliersModal: FunctionComponent = () => {
	const {
		isOpen,
		onToggleIsDeletingSelectedSuppliers,
		isLoading,
		onDeleteSelectedSuppliers,
	} = useDeleteSelectedSuppliersModal();
